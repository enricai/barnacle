...
const logger = (0, logging_1.getScriptLogger)("probe-setinputfiles");
...
async function main() {
    ...
    try {
        ...
        const filesLength = await page.evaluate(`(() => { const el = document.querySelector('#file-upload'); return el && el.files ? el.files.length : -1; })()`);
...
//# sourceMappingURL=probe-setinputfiles.js.map