 ...
 */
class StepVerificationError extends ScraperError {
    kind;
    constructor(message = "recon step failed verification after all heal attempts", kind = "cascade-exhausted") {
        super(message, false);
        this.kind = kind;
    }
}
exports.StepVerificationError = StepVerificationError;
/**
 ...
 */
class HttpSchemaError extends ScraperError {
    constructor(message = "http response schema mismatch") {
        super(message, false);
    }
}
exports.HttpSchemaError = HttpSchemaError;
/**
 ...
 */
class HttpBotChallengeError extends ScraperError {
    constructor(message = "http bot challenge or auth required") {
        super(message, false);
    }
}
exports.HttpBotChallengeError = HttpBotChallengeError;
/**
 ...
 */
class HttpServerError extends ScraperError {
 ...
 */
class MissingFormMapKeyError extends ScraperError {
    missingKeys;
    context;
...
exports.MissingFormMapKeyError = MissingFormMapKeyError;
