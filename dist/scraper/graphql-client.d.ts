...
export declare function createGraphqlClient<TResponse>(options: GraphqlClientOptions<TResponse>): (operationName: string, query: string, variables: Record<string, unknown>, requestOptions?: GraphqlRequestOptions) => Promise<TResponse>;
