 ...
 * value or side effects. Also patches `Object.defineProperty` itself so a
 * site script that replaces `window.hcaptcha`'s whole property descriptor
 * (rather than assigning through it) still gets its value or getter wrapped
