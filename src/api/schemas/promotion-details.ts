...
const promotionGuestRestrictionsSchema = z
  .object({
...
const promotionSchema = z
  .object({
    ...
    agencyTypes: z.array(z.string()).optional(),
    occupancyRestrictions: z.array(z.unknown()).optional(),
    targetedOfferType: z.string().optional(),
  })
  .passthrough();
