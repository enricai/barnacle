 ...
 */
export interface VpsStatusDetail {
  code: number;
...
export interface VpsErrorEnvelope {
  status: {
    httpStatus: string;
    dateTime: string;
...
export class EmptyRequestError extends VpsError {
  constructor(message = "request body is empty") {
    super(VPS_ERROR_CODES.EMPTY_REQUEST, message);
  }
}

export class ResourceNotFoundError extends VpsError {
  constructor(message = "resource not found") {
    super(VPS_ERROR_CODES.RESOURCE_NOT_FOUND, message);
  }
}
...
export class TimeoutError extends VpsError {
  constructor(message = "upstream request timed out") {
    super(VPS_ERROR_CODES.TIME_OUT, message);
  }
}
...
export class GenericError extends VpsError {
  constructor(message = "internal server error") {
    super(VPS_ERROR_CODES.GENERIC_ERROR, message);
  }
}
