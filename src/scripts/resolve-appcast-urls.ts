 ...
 *
 * Why this exists: the consumer's URL resolution pipeline (`ScrapedJobUrlResolutionCache`)
 ...
 * browser-based resolution ourselves with advancedStealth (the consumer's
