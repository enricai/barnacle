/**
 * Generated by recon-generate.ts — Stagehand browser fallback for custom-header-extraction-cast-test-23366.
...
import type { CustomHeaderExtractionCastTest23366Payload, CustomHeaderExtractionCastTest23366Response } from "@/sites/custom-header-extraction-cast-test-23366/contract";

const logger = getLogger({ name: "custom-header-extraction-cast-test-23366-browser-flow" });

const CustomHeaderExtractionCastTest23366BrowserSchema = z.object({
...
/**
 * Drives custom-header-extraction-cast-test-23366 through the recon flow and extracts structured data. This is
 ...
 */
export async function runCustomHeaderExtractionCastTest23366BrowserFlow(
  stagehand: Stagehand,
  entryUrl: string,
  payload: CustomHeaderExtractionCastTest23366Payload,
  sessionProxy: SessionProxyTuple | null
): Promise<CustomHeaderExtractionCastTest23366Response> {
  ...
  try {
    const result = await guardedExtract(
      ...
      CustomHeaderExtractionCastTest23366BrowserSchema
    );
    return { ...result, verified: true } as unknown as CustomHeaderExtractionCastTest23366Response;
  } catch (error) {
    ...
    return { verified: false } as unknown as CustomHeaderExtractionCastTest23366Response;
  }
}
