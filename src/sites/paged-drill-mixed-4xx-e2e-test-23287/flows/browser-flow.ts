/**
 * Generated by recon-generate.ts — Stagehand browser fallback for paged-drill-mixed-4xx-e2e-test-23287.
...
import type { PagedDrillMixed4xxE2eTest23287Payload, PagedDrillMixed4xxE2eTest23287Response } from "@/sites/paged-drill-mixed-4xx-e2e-test-23287/contract";

const logger = getLogger({ name: "paged-drill-mixed-4xx-e2e-test-23287-browser-flow" });

const PagedDrillMixed4xxE2eTest23287BrowserSchema = z.object({
...
/**
 * Drives paged-drill-mixed-4xx-e2e-test-23287 through the recon flow and extracts structured data. This is
 ...
 */
export async function runPagedDrillMixed4xxE2eTest23287BrowserFlow(
  stagehand: Stagehand,
  entryUrl: string,
  payload: PagedDrillMixed4xxE2eTest23287Payload,
  sessionProxy: SessionProxyTuple | null
): Promise<PagedDrillMixed4xxE2eTest23287Response> {
  ...
  { instruction: "browse paged cruise listing", optional: false, upload: false, submitStep: false },
  { instruction: "drill into cruise pricing", optional: false, upload: false, submitStep: true },
  ];
  ...
  try {
    const result = await guardedExtract(
      ...
      PagedDrillMixed4xxE2eTest23287BrowserSchema
    );
    return { ...result, verified: true } as unknown as PagedDrillMixed4xxE2eTest23287Response;
  } catch (error) {
    ...
    return { verified: false } as unknown as PagedDrillMixed4xxE2eTest23287Response;
  }
}
